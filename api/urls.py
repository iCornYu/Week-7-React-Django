...
urlpatterns = [
    ...
    path('products/add/', views.addCart, name='api-addCart'),
    path('cart/<str:username>/', views.myCart, name='api-Cart'),
    path('cart/<str:username>/delete/<int:cart_id>', views.deleteCart, name='api-deletecart'),
]
